...
co2_fluxes_exp <- flux_calc(co2_slopes_exp_flag,
                            ...
                            temp_air_col = "Tcham") |>
  rename(
    flux_co2 = "flux", # to avoid any confusion later
    model_co2 = "model",
    slope_co2 = "f_slope_calc"
  )

# printing the columns we are interested in here
co2_fluxes_exp |>
  select(f_fluxID, Tsoil, PAR, slope_co2, datetime, flux_co2, model_co2)
```
...
ch4_fluxes_qua <- flux_calc(ch4_slopes_qua_flag,
                            ...
                            temp_air_col = "Tcham") |>
  rename(
    flux_ch4 = "flux", # to avoid any confusion later
    model_ch4 = "model",
    slope_ch4 = "f_slope_calc"
  )

# printing the columns we are interested in here
ch4_fluxes_qua |>
  select(f_fluxID, Tsoil, PAR, slope_ch4, datetime, flux_ch4, model_ch4)
```
...
n2o_fluxes_lin <- flux_calc(n2o_slopes_lin_flag,
                            ...
                            temp_air_col = "Tcham") |>
  rename(
    flux_n2o = "flux", # to avoid any confusion later
    model_n2o = "model",
    slope_n2o = "f_slope_calc"
  )

# printing the columns we are interested in here
n2o_fluxes_lin |>
  select(f_fluxID, Tsoil, PAR, slope_n2o, datetime, flux_n2o, model_n2o)
```
